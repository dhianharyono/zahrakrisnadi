...
const ScrollToTop: React.FC = () => {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.a
          href={CONTACT_INFO.whatsapp.url('Halo Kak Zahra, saya ingin konsultasi gizi...')}
          target="_blank"
        ...
        >
          ...
          <span className="max-w-0 overflow-hidden whitespace-nowrap opacity-0 group-hover:max-w-xs group-hover:opacity-100 group-hover:pl-2 group-hover:pr-1 transition-all duration-500 ease-in-out font-medium text-sm text-white">
            Chat dengan kami
          </span>
        </motion.a>
      )}
