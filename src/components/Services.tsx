...
const Services: React.FC<ServicesProps> = ({ showPricing = true }) => {
  ...
  return (
    <section
      id='services'
      className='py-12 sm:py-24 bg-slate-50/60 relative overflow-hidden'
    >
        ...
        >
          {SERVICES_DATA.map((service, idx) => (
            <motion.div
              ...
              variants={itemVariants}
              whileHover={{ y: -6 }}
              className={`group relative rounded-3xl p-6 sm:p-7 transition-all duration-300 flex flex-col justify-between ${
                service.highlight
            ...
            >
              ...
              <div className='mt-auto pt-6 border-t border-slate-100'>
                <button
                  ...
                  className={`w-full py-3 px-6 rounded-full font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer ${
                    service.highlight
        ...
        <div className='md:hidden'>
          ...
          >
            {SERVICES_DATA.map((service, idx) => (
              <div
                key={idx}
                className={`shrink-0 w-[82vw] max-w-[320px] rounded-2xl sm:rounded-3xl p-5 flex flex-col justify-between snap-center ${
                  service.highlight
                    ? 'bg-white ring-2 ring-amber-500 shadow-md'
              ...
              >
                ...
                <div className='mt-auto pt-3 border-t border-slate-100'>
                  <button
                    ...
                    className={`w-full py-2.5 px-4 rounded-full font-bold text-xs transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer ${
                      service.highlight
                        ? 'bg-amber-500 hover:bg-amber-600 text-white'
                  ...
                  >
                    {pricingPlans.map((plan) => {
                      ...
                      return (
                        <div
                          key={plan._id}
                          className={`shrink-0 w-[82vw] sm:w-[320px] md:w-[360px] max-w-[340px] rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 transition-all duration-300 flex flex-col relative snap-center ${
                            isHighlight
                        ...
                        >
                          ...
                          <button
                            ...
                            className={`w-full py-2.5 sm:py-3.5 rounded-full font-bold flex items-center justify-center transition-all cursor-pointer text-xs sm:text-sm md:text-base mt-auto shadow-xs hover:shadow-md ${
                              isHighlight
                                ? 'bg-amber-500 hover:bg-amber-600 text-white'
                                : 'bg-slate-100 hover:bg-amber-50 hover:text-amber-600 text-slate-800 border border-slate-200/80'
                            }`}
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (pricingScrollRef.current) {
                              ...
                              const itemWidth =
                                scrollWidth / pricingPlans.length;
