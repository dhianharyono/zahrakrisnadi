      ...
      <div className='space-y-8 pb-10 animate-pulse'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
              className='h-40 bg-white/60 backdrop-blur-sm rounded-3xl border border-white/60 shadow-sm p-6 flex flex-col justify-between'
            >
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
          <div className='h-87.5 bg-white/60 backdrop-blur-sm rounded-3xl border border-white/60 shadow-sm p-6'>
            <div className='h-6 w-32 bg-gray-200 rounded-lg mb-6'></div>
            <div className='h-64 w-64 mx-auto bg-gray-100 rounded-full'></div>
          </div>
          <div className='lg:col-span-2 h-87.5 bg-white/60 backdrop-blur-sm rounded-3xl border border-white/60 shadow-sm p-6'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          <div className='h-75 bg-white/60 backdrop-blur-sm rounded-3xl border border-white/60 shadow-sm p-6'></div>
          <div className='h-75 bg-white/60 backdrop-blur-sm rounded-3xl border border-white/60 shadow-sm p-6'></div>
        </div>
      </div>
    );
      ...
      <header className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
        <div>
          ...
          <p className='text-gray-500 mt-1 text-sm'>
            Ringkasan aktivitas dan statistik pasien.
          </p>
        </div>
                  ...
                  <div className='flex items-center gap-2'>
                    <div className='h-2 w-24 bg-gray-100 rounded-full overflow-hidden'>
                      <div
                        ...
                        style={{
                          width: `${(item.count / stats.totalAssessments) * 100}%`,
                        }}
                      ></div>
                    </div>
