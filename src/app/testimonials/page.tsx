    ...
    return (
      <div className='min-h-screen bg-[#FDFBF7] flex items-center justify-center p-4 font-sans'>
        <div className='bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center animate-fade-in'>
          ...
          <h2 className='text-xl md:text-2xl font-serif font-bold text-gray-800 mb-1 md:mb-2'>
            Terima Kasih!
          </h2>
          <p className='text-gray-600 mb-6 text-xs md:text-sm'>
            Cerita sukses Anda telah kami terima.
          </p>
          <button
            onClick={() => router.push('/')}
      ...
      <div className='py-12 px-4'>
        <div className='max-w-xl mx-auto'>
          <div className='text-center mb-6 md:mb-10'>
            <h1 className='text-xl md:text-3xl font-serif font-bold text-gray-800 mb-1 md:mb-3'>
              Bagikan Cerita Suksesmu
            </h1>
            <p className='text-gray-600 text-xs md:text-sm'>
              Pengalaman Anda sangat berarti bagi kami dan orang lain.
            </p>
          </div>
            ...
            <div className='space-y-6'>
              <div>
                ...
                <input
                  ...
                  className='w-full px-4 py-3 text-xs rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-gray-400 text-sm md:text-sm'
                />
              </div>
